    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="font-size-18">Task-uri proprii</h4>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row my-4">
                        ...
                        $where = "where t.utilizator_asignat=".$id_utilizator;
                        ...
                        $result = mysqli_query($db, "select t.*, u.nume as nume_utilizator_asignat from taskuri t left join utilizatori u on u.id = t.utilizator_asignat ".$where." limit ".$limit." offset ".$offset);
